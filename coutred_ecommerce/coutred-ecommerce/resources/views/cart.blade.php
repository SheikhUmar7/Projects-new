          ...
          <div class="col-9 col">
            ...
            <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="row" >
                        <img src="{{ $item->attributes->image }}" alt="" width="90%" height="90%">
                      ...
                      <td class="justify-center mt-6 md:justify-end md:flex">
                        <div class="h-10 w-28">
                          <div class="relative flex flex-row w-full h-8">
                            ...
                            <button class="px-4 mt-1 u-c py-1.5  rounded rounded ">Update</button>
                            </form>
                          </div>
                        </div>
                      </td>
                    ...
                    <td>
                        <form action="{{ route('cart.remove') }}" method="POST">
                            ...
                            <button class="btn">
                                <img  width="14" height="14" src="https://img.icons8.com/material-sharp/24/multiply.png" alt="multiply"/>
                            </button>
